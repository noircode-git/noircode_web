          ...
          >
            ...
            >
              <div className="relative inline-block">
                ...
                <img
                  src={theme === 'light' ? "/images/image0_black.png" : "/images/image0_1761121323009.png"}
                  alt="Noircode"
            ...
            {[
              {
                ...
                image: "/images/modern_web_design_da_e4b71a98.jpg",
                delay: 0,
              },
              {
                title: "REF. 2",
                tech: "TypeScript, Express, MongoDB",
                image: "/images/modern_web_design_da_8380accf.jpg",
                delay: 0.1,
              },
              {
                title: "REF. 3",
                tech: "Python, FastAPI, Redis",
                image: "/images/professional_develop_1147f882.jpg",
                delay: 0.2,
              },
              {
                title: "REF. 4",
                tech: "Next.js, Tailwind, Vercel",
                image: "/images/mobile_app_developme_865bc70e.jpg",
                delay: 0.3,
              },
              {
                title: "REF. 5",
                tech: "React, Stripe, AWS",
                image: "/images/professional_develop_133eea55.jpg",
                delay: 0.4,
              },
              {
                title: "REF. 6",
                tech: "React Native, Firebase",
                image: "/images/mobile_app_developme_5d0b2db9.jpg",
                delay: 0.5,
              },
            ].map((project, index) => (
              <motion.div
