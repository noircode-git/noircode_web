      ...
      <section className="py-20">
        <div className="container mx-auto px-6 max-w-4xl">
          <div className="space-y-8">
            <div>
              <h2 className="font-semibold text-xl mb-4">Správce údajů</h2>
              <p className="text-muted-foreground">Noircode je správcem vašich osobních údajů ve smyslu GDPR.</p>
            </div>
            <div>
              <h2 className="font-semibold text-xl mb-4">Jaké údaje zpracováváme</h2>
              <p className="text-muted-foreground">Jméno, e-mail, telefon a další informace poskytnuté dobrovolně prostřednictvím kontaktního formuláře.</p>
            </div>
            <div>
              <h2 className="font-semibold text-xl mb-4">Vaše práva</h2>
              <p className="text-muted-foreground">Máte právo na přístup, opravu, výmaz, omezení zpracování a přenositelnost údajů.</p>
            </div>
          </div>
        </div>
      </section>
