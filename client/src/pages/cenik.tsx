    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-6 relative">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed mb-8">
              Transparentní ceny pro naše služby. Každý projekt je jedinečný, proto vám připravíme 
              individuální cenovou nabídku podle vašich potřeb.
            </p>
            <Button
              size="lg"
      ...
      <section className="py-20">
        <div className="container mx-auto px-6">
          <h2 className="font-['Space_Grotesk'] text-3xl md:text-4xl font-semibold mb-12 text-center">
            Orientální ceník
          </h2>
          <div className="max-w-3xl mx-auto text-center">
            <p className="text-lg text-muted-foreground">
              Ceny se liší podle složitosti projektu. Kontaktujte nás pro bezplatnou konzultaci 
              a individuální cenovou nabídku šitou na míru vašim potřebám.
            </p>
          </div>
        </div>
      </section>
